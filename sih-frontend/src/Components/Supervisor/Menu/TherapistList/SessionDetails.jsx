        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-4 rounded-xl shadow-md">
            ...
            <div className="space-y-2">
              ...
              <div className="flex justify-between">
                <span className="font-medium text-blue-700">Therapist</span>
          ...
          {/* Performance Chart */}
          <div className="bg-white p-4 rounded-xl shadow-md h-72 w-full ">
          ...
          <div className="md:col-span-3 bg-white p-4 rounded-xl shadow-md ">
            <div className="flex items-center mb-4">
              ...
              <h2 className="text-lg font-semibold text-blue-800">Session Summary</h2>
            </div>
